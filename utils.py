...
def setup_cognito_user_pool() -> Dict[str, str]:
    ...
    def _secret_hash(uname, cid, csecret):
        msg = uname + cid
        dig = hmac.new(csecret.encode('utf-8'), msg.encode('utf-8'), hashlib.sha256).digest()
    ...
    discovery_url = f"https://cognito-idp.{region}.amazonaws.com/{pool_id}/.well-known/jwks.json"
